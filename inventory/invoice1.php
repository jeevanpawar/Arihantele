...
<div class="d1">
 ...
 Email ID : arihantelectricalsnashik@gmail.com<br></div>
    ...
    <tr>
  		<td>Party's TIN NO :<?php echo"$row1[6]"; ?></td>
  		
 	</tr>
    <tr>
  		<td>Payment Terms:<?php echo"$row1[6]"; ?></td>
    ...
    <tr><td>
        ...
        <td width="150">Description of Goods</td>
        <td width="60">Qty.</td>
        <td width="60">Rate</td>
        <td width="70">Disc %</td>
        <td width="49">Tax</td>        
    ...
    <table class="tot" border="1">
        ...
        <tr>
            <td colspan="2">VAT TIN No. 27020894568 V w.e.f. 17-3-12 </td>
    		<td colspan="2">Vat TOTAL</td>
    		<td><?php echo"$row1[4]"; ?></td>  
        </tr>
        <tr>
            <td colspan="2">TIN No. 27020894568 C w.e.f. 17-3-12</td>
    		<td colspan="2">Vat TOTAL</td>
    		<td><?php echo"$row1[4]"; ?></td>  
        </tr>
        <tr>
			<td colspan="2">VAT -5 %<label></label> VAT -5 %<label></label></td>
    ...
    <table>
	<tr> 
    <td width="390"><p align="justify"><font size="-2">"I/we hereby certify that my/our registration certificate under the Maharashtra Value Added Tax Act. 2002 is in force on the date on which the sale of the goods specified in this tax invoice is made by me/us and that the transaction of sale covered by this tax invoice has been effected by me/us and it shall be accounted for in the turnover of sale while filling of return and the due tax, if any, payable on the sale has been paid or shall be paid "</p>	</td>	
 <td><p align="right"><b><font size="-1">For ARIHANT ELECTRICALS</b></p></font></font></td> 
	</tr>
	</table>
    <br><br>
	...
	<div class="d5"><img src="../../Arihant electricals/logo1.jpg"></div>
