...
$qry_s="select SUM(st_amt) from sub_stock where st_id='$id'";
$res_s=mysql_query($qry_s);
$row_s=mysql_fetch_array($res_s);

$qry_sn="select * from sub_stock where st_id='$id'";
...
<body>
        ...
        <tr class="search_res">
        <td class="info">
        <center>Supplier:<?php echo $row_sn[3]; ?></center>
        </td>
        </tr>
        </table>
		...
		while($row_d=mysql_fetch_array($res_d))
		{
			echo "<tr class='pagi'>";
			echo "<td >";
			echo "<a href='viewreciept.php?id=$row_d[0]' class='print'>&nbsp;&nbsp;&nbsp;View&nbsp;&nbsp;&nbsp;</a>";
			echo "</td>";
			echo "<td>";
        ...
        <td><input id="ename" type="text" readonly class="q_in" name="t1" value="<?php echo $row_sn[3]; ?>"></td>
        </tr>
        <tr>
